...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = (function (_React$Component) {
	  ...
	  _createClass(Index, [{
	    ...
	    value: function onInputChange(e) {
	      ...
	      _superagent2["default"].post("/api/add?content=" + value).end(function () {});
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      ...
	      var _state$todos = this.state.todos;
	      var todos = _state$todos === undefined ? [] : _state$todos;

	      return _react2["default"].createElement(
	        "div",
	        null,
	        _react2["default"].createElement("input", { onKeyUp: function (e) {
	            return _this.onInputChange(e);
	          } }),
	...
	if (typeof window !== "undefined") {
	  ...
	  _react2["default"].render(_react2["default"].createElement(Index, data), document.getElementById("app"));
	}
